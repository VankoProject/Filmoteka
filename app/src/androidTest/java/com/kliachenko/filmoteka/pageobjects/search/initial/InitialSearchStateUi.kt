package com.kliachenko.filmoteka.pageobjects.search.initial
...
class InitialSearchStateUi(
    ...
    private val rootInteraction = onView(
        allOf(
            ...
            RecyclerViewMatcher(
                position = 0,
                targetViewId = initialSearchTextViewId,
    ...
    private val textInteraction = onView(
        allOf(
            ...
            withId(initialSearchTextViewId),
